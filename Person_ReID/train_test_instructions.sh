...
# Random Patch Noise
python train.py --gpu_ids 0  --name use_rn18_market_5 --use_rn18 --batchsize 32  --data_dir data/Market/pytorch --rpn 0.5 --total_epoch 60
python test.py  --gpu_ids 0  --name use_rn18_market_5 --use_rn18 --batchsize 32  --test_dir data/Market/pytorch --which_epoch last
...
python train.py --gpu_ids 0 --name eff_market_5 --use_efficient --batchsize 32  --data_dir data/Market/pytorch --rpn 0.5 --total_epoch 60
python test.py --gpu_ids 0 --name eff_market_5 --use_efficient  --batchsize 32  --test_dir data/Market/pytorch --which_epoch last 
...
python train.py --gpu_ids 0  --name use_rn18_duke_4 --use_rn18 --batchsize 32  --data_dir data/DukeMTMC-reID/pytorch --ours 0.5 --total_epoch 60
...
python train.py --gpu_ids 0 --name eff_duke_4 --use_efficient --batchsize 32  --data_dir data/DukeMTMC-reID/pytorch --ours 0.5 --total_epoch 60
